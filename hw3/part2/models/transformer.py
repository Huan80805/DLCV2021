...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, pos_embed, tgt, tgt_mask):
        ...
        hs, attn_weight = self.decoder(tgt, memory, memory_key_padding_mask=mask, tgt_key_padding_mask=tgt_mask,
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory,
        ...
        # if require weight: return attn_output, attn_weight
        ...
        tgt = self.norm3(tgt)
        #print('post attn_weight:', attn_weight)
    ...
    def forward_pre(self, tgt, memory,
        ...
        tgt = tgt + self.dropout3(tgt2)
        #print('pre attn_weight:', attn_weight)
        return tgt, attn_weight
